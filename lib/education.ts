...
export const education: EducationEntry[] = [
  {
    ...
    degree: 'M.B.A.',
    field: 'Entrepreneurship, Product Management & Venture Capital',
    year: '2022',
    highlights: [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Coursework and research in reinforcement learning and Markov models, including a Markov chain text generator',
